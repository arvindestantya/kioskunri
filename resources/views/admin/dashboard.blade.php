    ...
    <div class="py-12 bg-gray-50 dark:bg-gray-900">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="space-y-8">
                ...
                <div>
                    <h3 class="text-xl font-bold text-gray-800 dark:text-gray-200 mb-4 px-1">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        @forelse ($visitorData as $facultyName => $count)
                            <div class="bg-white dark:bg-gray-800 p-5 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm flex items-center gap-5 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                                ...
                                <div>
                                    <p class="text-3xl font-extrabold text-gray-900 dark:text-white">{{ $count }} Pengunjung</p>
                                    <p class="text-sm text-gray-500 dark:text-gray-400 font-semibold truncate" title="{{ $facultyName }}">
                                        {{ $facultyName }}
                                    </p>
                                </div>
                            </div>
